...
exports.ClientSchema = new mongoose.Schema({
    fullName: { type: mongoose_1.Schema.Types.String, required: true },
    email: { type: mongoose_1.Schema.Types.String, required: true },
    mobileNo: { type: mongoose_1.Schema.Types.String, required: true },
    password: { type: mongoose_1.Schema.Types.String, required: true },
}, {
    versionKey: false,
    timestamps: true,
    collection: enum_1.ENUM.COLLECTIONS.CLIENT,
});
